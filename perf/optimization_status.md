...
## 2026-07-06: GELU reference kernel (activations/gelu) — SYCL + oneDNN — KEPT
...
## 2026-07-06: norms (rms_norm, layernorm) — SYCL + oneDNN, three truisms smashed — LANDED
...
## 2026-07-06: softmax (activations/softmax) — SYCL + oneDNN — LANDED
...
## 2026-07-06: 16-byte vector-load pass — bf16/f16 row kernels ~2x, one truism smashed and one own-conclusion reversed — LANDED
...
## 2026-07-06: activations breadth — silu, gelu_backward, glu (feature-matrix pass) — KEPT
...
## 2026-07-06: matmul/dense_gemm — native SYCL tile + oneDNN (XMX), family opened — LANDED
...
## 2026-07-06: three more families — rope (attention), adamw (optimizers), argmax (sampling) — LANDED
...
## 2026-07-06: quantization/qgemv int4 — Marlin/Metal-guided dequant GEMV opens the family — LANDED
...
## 2026-07-06: quantization/qgemm int8 w8a8 — oneDNN XMX hits 182 TOPS — LANDED
...
## 2026-07-06: quantization/fp8_gemm (e4m3, e5m2) — works natively, not yet fast on B60 — KEPT
...
## 2026-07-07: quantization/mxfp4_gemv — OCP microscaling FP4 decodes natively on Intel — LANDED
...
## 2026-07-07: quantization/nvfp4_gemv — NVIDIA FP4 decodes natively on Intel too — LANDED
...
## 2026-07-07: quantization/gguf_gemv — llama.cpp q8_0/q4_0 decode natively on Intel — LANDED
...
## 2026-07-07: FULL-MATRIX push begins (breadth-first). serving family opened — UNLABELED
...
## 2026-07-07: Track C — PyTorch-XPU binding works end-to-end (validated vs torch.xpu) — UNLABELED
...
## 2026-07-07: quantization — act_quant (w8a8 activation quant) + all formats done — UNLABELED
...
## 2026-07-07: Track B quant depth — GGUF q6_K k-quant — UNLABELED
...
## 2026-07-07: Track B depth begins — attention + sampling suite — UNLABELED
...
## 2026-07-07: Optimization pass #2 — 4-bit quant-GEMV decode (truism busted) — UNLABELED
...
## 2026-07-08: quantization/fp8_gemm — "fp8 is not accelerated on B60" mostly busted — LANDED
...
## 2026-07-08: quantization/nvfp4_gemv pass #3 — bit-relocation decode, 1.92x — LANDED
...
## 2026-07-08: vLLM integration — native NVFP4 MoE + fp8 W8A16 GEMV (Qwen3.6-35B-A3B-NVFP4, 1x B60) — LANDED
...
## 2026-07-09: Deep dive — path to 60 tok/s (launch-reduction levers, Qwen3.6-35B-A3B-NVFP4, 1x B60) — UNLABELED
...
## 2026-07-09: vLLM full XPU graph + split NVFP4 MoE reaches 68 tok/s — UNLABELED
...
## 2026-07-09: dual-B60 TP2, FP8 KV cache, 128k context — UNLABELED
...
## 2026-07-09: segmented XPU Graph enables TP2 decode — UNLABELED
...
## 2026-07-10: Port Qwen serving kernels back into QuixiCore-XPU — UNLABELED
...
## 2026-07-10: Qwen GDN state-slot contract synchronization — CANDIDATE
...
## 2026-07-10: NVFP4 split-MoE output-row tiling — UNLABELED
...
## 2026-07-11: NVFP4 MoE paired gate/up decode — REJECTED
...
## 2026-07-11: NVFP4 MoE packed-dot vector loads — REJECTED
...
## 2026-07-22: attention_f16ctx (fused f16 context store) — KEPT
...
## 2026-07-22: pool_mean_rms_l2 (sentence-embedding pooling head) — KEPT
...
## 2026-07-22: rms_residual_next (fused residual-add + double RMSNorm -> f16) — KEPT
...
## 2026-07-22: qk_norm_rope (fused per-head QK-norm + query-scale + RoPE) — KEPT
...
## 2026-07-22: glu_gelu_f16 (GEGLU with fused f16 output) — KEPT
...
## 2026-07-22: attn_swa (symmetric sliding-window attention) — KEPT
...
## 2026-07-22: w4a16_gemm (int4-weight x f16/bf16-activation DPAS GEMM) — KEPT
