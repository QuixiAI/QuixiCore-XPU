...
int main(int argc, char** argv) {
  ...
  if (kernel == "gguf_gemv") {
    const std::size_t Nn = rows, Kk = dim;
    const int gt = (approx_s == "q4_0") ? 1 : (approx_s == "q6_K" ? 2 : (approx_s == "q4_K" ? 3 : (approx_s == "q5_K" ? 4 : (approx_s == "q2_K" ? 5 : (approx_s == "q3_K" ? 6 : 0)))));
    ...
    std::cout << "{\"schema_version\":2,\"kernel\":\"gguf_gemv\",\"variant\":\"sycl\",\"gguf\":\""
              << (gt == 6 ? "q3_K" : gt == 5 ? "q2_K" : gt == 4 ? "q5_K" : gt == 3 ? "q4_K" : gt == 2 ? "q6_K" : gt == 1 ? "q4_0" : "q8_0") << "\",\"dtype\":\"" << dtype_name(dt)
